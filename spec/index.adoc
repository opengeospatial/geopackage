...
_Previous Version: http://www.opengis.net/doc/IS/geopackage/1.2.0_ +
...
[WARNING]
====
This document is not an OGC Standard. This document is distributed for review and comment. This document is subject to change without notice and may not be referred to as an OGC Standard. This is a revision to http://www.geopackage.org/spec120/index.html[GeoPackage 1.2 (OGC 12-128r14)]. At this time there are only administrative differences between this version and the adopted version.
====
