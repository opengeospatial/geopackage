...
[WARNING]
====
This document is not an OGC Standard. This document is distributed for review and comment. This document is subject to change without notice and may not be referred to as an OGC Standard. This is a revision to http://www.geopackage.org/spec120/index.html[GeoPackage 1.2.1 (OGC 12-128r15)]. There are both substantive and administrative differences between this version and the adopted version.
For more information, see link:https://gitlab.com/imagemattersllc/ogc18-066/-/blob/master/rn.adoc[the release notes].
====
