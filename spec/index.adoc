...
:releasenotes: https://gitlab.com/imagemattersllc/ogc18-066/-/blob/master/rn.adoc
...
Internal reference number of this OGC® document: OGC 12-128r16 +
Version: 1.3_SNAPSHOT +
Category: OGC® Encoding Standard +
Editor:   Jeff Yutzler +
Editor Emeritus: Paul Daisey +
_Previous Version: http://www.opengis.net/doc/IS/geopackage/1.2.1_ +
_Publication Date: TBD +
_Approval Date:   TBD +
_Submission Date: TBD +
...
[WARNING]
====
This document is not an OGC Standard. This document is distributed for review and comment. This document is subject to change without notice and may not be referred to as an OGC Standard. This is a revision to http://www.geopackage.org/spec121/index.html[GeoPackage 1.2.1 (OGC 12-128r15)]. There are both substantive and administrative differences between this version and the adopted version.
For more information, see link:{releasenotes}[the release notes].
====
