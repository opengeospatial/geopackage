...
This OGC GeoPackage WKT for Coordinate Reference Systems Extension defines requirements for encoding coordinate reference systems and coordinate epochs in a GeoPackage.
