:Title: OGC GeoPackage WKT for Coordinate Reference Systems Extension
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Approval Date:   2022-08-20
|Publication Date:   2022-10-14
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/geopackage-crs-wkt/1.1
|Internal reference number of this OGC(R) document:    21-057
|Version: 1.1.0
