:Title: OGC GeoPackage Conceptual Model
:titletext: OGC GeoPackage Conceptual Model
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    21-053
|Version: 1.0
...
include::clause_8_logical_model.adoc[]
