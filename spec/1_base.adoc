...
:req2_foot2: footnote:[Applications should be aware of the possibility that newer versions of GeoPackage may be published and that the application may have a higher suffix than "11".]
...
[requirement]
A GeoPackage SHALL contain an appropriate value in the application ID field of the SQLite database header to indicate that it is a GeoPackage. {req2_foot1} The value SHALL have a prefix of 0x4750 ("GP" in ASCII). A value of 0x47503131 ("GP11" in ASCII) SHALL indicate a GeoPackage version 1.1 file. {req2_foot2}
