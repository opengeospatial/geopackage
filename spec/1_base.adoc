...
[requirement]
A GeoPackage SHALL contain 0x4750313032 ("GP102" in ASCII) in the application id field of the SQLite database header to indicate a GeoPackage version 1.0 file. {req2_foot1}
