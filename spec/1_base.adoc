...
:req2_foot3: footnote:[For more information on maximum database size, see Section 14 of https://www.sqlite.org/limits.html.]
...
The maximum size of a GeoPackage file is about 140TB{req2_foot3}.
