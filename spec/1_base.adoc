...
SQLite databases that use constructs from the GeoPackage standard but extend that to contain any of these elements are referred to as Extended GeoPackages throughout this standard.
