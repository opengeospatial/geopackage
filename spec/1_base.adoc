...
[requirement]
A GeoPackage SHALL contain 0x47503132 ("GP12" in ASCII) in the application id field of the SQLite database header to indicate a GeoPackage version 1.2 file. {req2_foot1}
