...
The required capabilities specified in this clause serve as the base for options and extensions capabilities specified in clause <<_options>> and extensions specified in clause <<_registered_extensions>>.
