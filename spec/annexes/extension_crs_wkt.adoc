...
|`definition_12_063` |TEXT |Well-known Text <<I34>> Representation of the Spatial Reference System |true|
|====
...
.Requirement 116
====
Values of the `definition_12_063` column SHALL be constructed per the WKT syntax in <<I34>>.
====
