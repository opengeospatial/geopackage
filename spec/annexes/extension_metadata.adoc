...
|`row_id_value` ^<<K30>>^ |INTEGER |NULL for `reference_scope` of 'geopackage', 'table' or 'column', or the rowid of a row record in the `table_name` table for `reference_scope` of 'row' or 'row/col' |yes | |
