...
|<<extension_tiled_gridded_elevation_data_png>> | tiled gridded elevation data
|<<extension_tiled_gridded_elevation_data_tiff>> | tiled gridded elevation data
|======
...
include::extension_tiled_gridded_elevation_data_png.adoc[]

include::extension_tiled_gridded_elevation_data_tiff.adoc[]
