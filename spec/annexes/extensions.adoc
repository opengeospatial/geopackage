...
|<<extension_tiled_gridded_coverage_data>> | coverages
|<<extension_related_tables>> | related tables
|======
...
include::extension_tiled_gridded_coverage_data.adoc[]

include::extension_related_tables.adoc[]
