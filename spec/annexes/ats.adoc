...
|*Test Purpose* |Verify that the `table_name` and `column_name` column values in the `gpkg_extensions` table are valid.
|*Test Method* |
...
.. Fail if any ge.table_name != sm.tbl_name (MAY both be NULL).
