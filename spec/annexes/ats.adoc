...
|*Test Method* |
. SELECT a.srs_id a_srs_id, b.srs_id b_srs_id FROM gpkg_geometry_columns a, gpkg_contents b WHERE a.table_name = b.table_name and a_srs_id != b_srs_id
...
|*Test Method* |
. SELECT a.srs_id a_srs_id, b.srs_id b_srs_id FROM gpkg_tile_matrix_set a, gpkg_contents b WHERE a.table_name = b.table_name and a_srs_id != b_srs_id
