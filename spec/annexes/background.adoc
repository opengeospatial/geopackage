...
| (chinese chars not working) Joshua |Feng China University |joshua@gis.tw
...
| (chinese chars not working) Yi-Min Huang |Feng China University |niner@gis.tw
...
|Pepijn Van Eeckhoudt |Luciad |pepijn.vaneeckhoudt@luciad.com
