...
interdependent specification facets of the SF-SQL <<9>><<10>><<11>> and SQL-MM (Spatial) <<12>> standards that serve as
...
widely adopted implementations and existing standards such as WMTS <<16>> and ISO metadata <<28>>, to integrate use of
...
|2.1.3.1.1, 2.2.6.1.1| Add x/y axis definitions to  min/max x/y column descriptions and WKB geometry description.
|=======================================================================
