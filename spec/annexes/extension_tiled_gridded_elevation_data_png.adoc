[[extension_tiled_gridded_elevation_data_png]]
...
|gpkg_2d_gridded_coverage_ancillary|null|`gpkg_elevation_tiles_png`|http://www.geopackage.org/spec/#extension_tiled_gridded_elevation_data_png|`read-write`
|gpkg_2d_gridded_tile_ancillary|null|`gpkg_elevation_tiles_png`|http://www.geopackage.org/spec/#extension_tiled_gridded_elevation_data_png|`read-write`
|name of actual http://www.geopackage.org/spec/#tiles_user_tables[tile pyramid user data table] containing unsigned integer data|`tile_data`|`gpkg_elevation_tiles_png`|http://www.geopackage.org/spec/#extension_tiled_gridded_elevation_data_png|`read-write`
|=======================================================================
