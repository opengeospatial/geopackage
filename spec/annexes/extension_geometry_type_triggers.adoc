...
The <t> and <c> template parameters in the geometry type trigger definition SQL template in Table xx below are to be replaced with the names of the feature table and geometry column being inserted or updated.
