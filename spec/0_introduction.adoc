...
This document is not an OGC Standard. It is distributed for review and comment and to evaluate use of github at https://github.com/opengis/geopackage for public comments in addition to the PDF document format that was provided by the OGC RFC at http://www.opengeospatial.org/standards/requests/115.
