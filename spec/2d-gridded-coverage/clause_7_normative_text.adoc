...
The following requirements class incorporates all the requirements that define the core of the TGCE. These 13 requirements are defined in the sub-clauses uo to the TIFF Encoding requirements clause.
