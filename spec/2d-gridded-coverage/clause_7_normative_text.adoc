...
The following requirements define mandatory and optional elements for the tile ancillary table definition.
...
The following are the requirements for the `CIS{two-colons}GeneralGridCoverage`, `class grid-regular` Tile Pyramid User Data Table extensions.
