...
|Issue   | 552| S | Clause 7 | Request supporting additional data types in GeoPackage coverages | Usability
|Issue   | 553| S | Clause 7 - Tiff | Request supporting multiple channels in a GeoPackage Coverage | Usability
|Issue   | 572| A | Requirement 21 | Requirement 21 still mentions Elevation | Change Request 572 - Consistency
|Issue   | 576| S | Clause 7 | Clarify existing requirements classes| Change Request 576
|Issue   | 553| S | Clause 7 | Modify Requirement 14 in support of TIFF changes| Change Request 553
|===
