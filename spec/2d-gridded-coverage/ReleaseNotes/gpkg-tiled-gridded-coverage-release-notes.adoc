:Title: OGC GeoPackage Tiled Gridded Coverage Version 1.1 Release Notes
:titletext: OGC GeoPackage Tiled Gridded Coverage Version 1.1 Release Notes
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Approval Date:   2021-11-24
|Publication Date:   2021-xx-xx
|External identifier of this OGC(R) document: http://www.opengis.net/doc/NOTE/GPKG-notes/1.1
|Internal reference number of this OGC(R) document:    21-047
|Version: 1.1
