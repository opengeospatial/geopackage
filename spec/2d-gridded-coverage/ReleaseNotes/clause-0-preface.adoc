...
This document provides the set of revision notes for the GeoPackage Tiled Gridded Coverage Extension Standard, version 1.1 [OGC 17-066r2] and does not modify that standard.
