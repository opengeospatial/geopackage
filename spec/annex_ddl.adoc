...
CREATE TABLE gpkg_extensions (
  ...
  scope TEXT NOT NULL,
  UNIQUE KEY (table_name, column_name, extension_name)
)
----
...
CREATE TABLE gpkg_geometry_columns (
  table_name TEXT UNIQUE NOT NULL REFERENCES gpkg_contents(table_name),
...
CREATE TABLE gpkg_tile_matrix_set (
  table_name TEXT PRIMARY KEY NOT NULL REFERENCES gpkg_contents(table_name),
  srs_id INTEGER NOT NULL REFERENCES gpkg_spatial_ref_sys(srs_id),
