...
When the WKBGeometry in a GeoPackageBinary is empty (i.e. 'ST_IsEmpty' returns
true), the empty geometry flag (Y) SHALL be 1 indicating an empty geometry,
otherwise the empty geometry flag SHALL be 0.
