...
If the geometry `type_name` value is "GEOMETRYCOLLECTION" then the feature table geometry column MAY geometries of type GeometryCollection containing zero or more geometries of any allowed geometry type.
