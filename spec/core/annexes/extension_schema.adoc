...
|`title` |TEXT |A human-readable title for the 'enum' value or NULL for 'range' or 'glob' constraint types.| yes|
|=======================================================================
...
CREATE TABLE gpkg_data_column_constraints (
  ...
  CONSTRAINT gdcc_ntt UNIQUE (constraint_name, constraint_type, title)
)
----
