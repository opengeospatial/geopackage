:Title: Release Notes for OGC GeoPackage 1.3.1
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Reference URL for this OGC(R) document: http://www.opengis.net/doc/NOTES/geopackage/1.3.1
|Internal reference number of this OGC(R) document:    21-004
...
|===
|*Copyright notice*
|Copyright (C) 2021-2023 Open Geospatial Consortium
