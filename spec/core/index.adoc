...
:releasenotes: https://github.com/opengeospatial/geopackage/blob/master/spec/core/release_notes/1.3.1/rn.adoc
...
Internal reference number of this OGC® document: OGC 12-128r18 +
Version: 1.3.1 +
Category: OGC® Encoding Standard +
Editor:   Jeff Yutzler +
Editor Emeritus: Paul Daisey +
_Previous Version: http://www.geopackage.org/spec130/_ +
_Publication Date: 2021-11-16_ +
_Approval Date:   2021-09-20_ +
_Submission Date: 2021-08-21_ +
